...
#define BOARD_INITPMODPINS_LCD_RST_GPIO_PIN_MASK (1U << 26U) /*!<@brief GPIO pin mask */
#define BOARD_INITPMODPINS_LCD_RST_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPMODPINS_LCD_RST_PIN 26U                   /*!<@brief PORT pin number */
#define BOARD_INITPMODPINS_LCD_RST_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                                             /* @} */
...
#define BOARD_INITPMODPINS_LCD_DC_GPIO_PIN_MASK (1U << 27U) /*!<@brief GPIO pin mask */
#define BOARD_INITPMODPINS_LCD_DC_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPMODPINS_LCD_DC_PIN 27U                   /*!<@brief PORT pin number */
#define BOARD_INITPMODPINS_LCD_DC_PIN_MASK (1U << 27U)      /*!<@brief PORT pin mask */
                                                            /* @} */
